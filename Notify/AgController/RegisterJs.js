...
myApp.controller('RegisterController', function ($scope, $http, $filter, RegistrationService)
{
    //Default Variable
...
myApp.factory('RegistrationService', function ($http, $q)
{
    var fac = {};
...
//.controller('RegisterController', function ($scope, RegistrationService) { //explained about controller in Part 2
//    //Default Variable
//    $scope.submitText = "Save";
//    $scope.submitted = false;
//    $scope.message = '';
